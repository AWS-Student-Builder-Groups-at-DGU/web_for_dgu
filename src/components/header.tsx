            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    <Link href="/" className="flex items-center space-x-2">
                        <Image src={Logo} alt={"logo"} className="h-15 w-15 text-orange-600" />
                        {/*<div className="bg-gradient-to-br from-white to-orange-50 p-2 rounded-lg shadow-md">*/}
                        {/*</div>*/}
                        <div className="flex flex-col">
                            <span className="font-bold text-lg text-white">AWS Cloud Club</span>
                            <span className="text-xs text-orange-100">Dongguk University</span>
                        </div>
                    </Link>
